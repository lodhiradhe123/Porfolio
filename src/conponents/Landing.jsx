...
function Landing() {
  return (
    <div className="  max-sm:w-full max-sm:items-start w-[100%] h-screen bg-pink-100   text-white flex flex-col items-center justify-center font-[Kanit] ">
      <div className="max-sm:w-[79%] max-sm:p-2 w-2/3 h-full mt-32 text-black ">
        <section className="">
